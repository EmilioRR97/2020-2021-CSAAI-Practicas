//----- Obtener elementos de video y configurarlo
...
//-- Imagenes estáticas a mostrar cuando el video no
//-- ha arrancado
...
btn_src_on.onclick = () => {
  ...
  //-- Reprodeucimos los vídeo, desde el comienzo
...
//-- Botón de Selección de las cámaras
btn_video1.onclick = () => {
  if (estado == true){
